...
var translations = map[string]map[string]string{
	...
	"drops.sub": {
		...
		"de": "Ein Drop ist ein Link, der ausschließlich Dateien annimmt. Alles, was dort ankommt, wird auf einen Schlüssel verschlüsselt, den es nur in deinem privaten Link gibt — nicht auf diesem Server."},
	"drops.new":               {"en": "New drop", "de": "Neuer Drop"},
	"drops.create":            {"en": "Create drop", "de": "Drop anlegen"},
	"drops.label":             {"en": "Name", "de": "Name"},
	"drops.label_ph":          {"en": "What is this drop for?", "de": "Wofür ist dieser Drop?"},
	...
	"drops.preset_one_h":      {"en": "One sender, one file, then the drop closes itself.", "de": "Ein Absender, eine Datei, danach schließt sich der Drop selbst."},
	...
	"drops.preset_open":       {"en": "Open drop box", "de": "Offener Drop"},
	...
	"drops.private_hint":   {"en": "The only way to read what arrives. It is not stored anywhere: if you lose it, everything sent to this drop is lost, for everyone.", "de": "Der einzige Weg, das Angekommene zu lesen. Er wird nirgends gespeichert: Geht er verloren, ist alles in diesem Drop unwiederbringlich weg — für alle."},
	"drops.saved_confirm":  {"en": "I have saved the private link", "de": "Ich habe den privaten Link gesichert"},
	"drops.list":           {"en": "Your drops", "de": "Deine Drops"},
	"drops.empty":          {"en": "No drops yet.", "de": "Noch keine Drops."},
	...
	"drops.confirm_close":  {"en": "Close this drop? It will stop accepting files.", "de": "Diesen Drop schließen? Er nimmt dann keine Dateien mehr an."},
	"drops.confirm_delete": {"en": "Delete this drop and everything sent to it? This cannot be undone.", "de": "Diesen Drop und alles darin löschen? Das lässt sich nicht rückgängig machen."},
	...
	"drop.closed":       {"en": "This drop is no longer accepting files.", "de": "Dieser Drop nimmt keine Dateien mehr an."},
	"drop.complete":     {"en": "This drop already has everything it was waiting for.", "de": "Dieser Drop hat bereits alles, worauf er gewartet hat."},
	"drop.one_file":     {"en": "This drop accepts a single file.", "de": "Dieser Drop nimmt genau eine Datei an."},
	"drop.n_files":      {"en": "This drop accepts %d files.", "de": "Dieser Drop nimmt %d Dateien an."},
	...
	"drop.pw_hint":      {"en": "This drop is password protected. Ask the recipient for it.", "de": "Dieser Drop ist passwortgeschützt. Frag den Empfänger danach."},
	...
	"inbox.kicker":  {"en": "Your drop", "de": "Dein Drop"},
	"inbox.empty":   {"en": "Nothing has been sent to this drop yet.", "de": "An diesen Drop wurde noch nichts gesendet."},
	"inbox.summary": {"en": "%d file(s) in %d delivery(ies)", "de": "%d Datei(en) in %d Lieferung(en)"},
	"inbox.created": {"en": "Drop created", "de": "Drop angelegt"},
	...
	"js.drop_created":       {"en": "Drop created", "de": "Drop angelegt"},
	"js.drop_create_failed": {"en": "The drop could not be created.", "de": "Der Drop konnte nicht angelegt werden."},
	...
	"js.drop_key_bad": {
		...
		"de": "Der Schlüssel dieses Drops passt nicht zum Link. Sende nichts: Entweder ist der Link beschädigt, oder der ausgelieferte Schlüssel gehört nicht dem Empfänger."},
	"js.drop_kem_missing":        {"en": "This browser cannot do the post-quantum key exchange this drop needs.", "de": "Dieser Browser beherrscht den Post-Quantum-Schlüsselaustausch nicht, den dieser Drop braucht."},
	"js.drop_full":               {"en": "This drop is full.", "de": "Dieser Drop ist voll."},
	"js.drop_file_limit":         {"en": "This drop accepts %s file(s) — the rest were not added.", "de": "Dieser Drop nimmt %s Datei(en) an — der Rest wurde nicht hinzugefügt."},
	"js.drop_closed":             {"en": "This drop is closed.", "de": "Dieser Drop ist geschlossen."},
	...
	"js.inbox_empty":             {"en": "Nothing has been sent to this drop yet.", "de": "An diesen Drop wurde noch nichts gesendet."},
